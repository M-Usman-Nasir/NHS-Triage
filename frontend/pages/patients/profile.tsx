...
export default function PatientsProfilePage() {
  ...
  return (
    <div
      className="flex min-h-[100dvh] min-h-screen flex-col items-center justify-center bg-white px-2 py-2 pt-[max(0.5rem,env(safe-area-inset-top))] pb-[max(0.5rem,env(safe-area-inset-bottom))] sm:px-4 sm:py-4 md:px-6 md:py-6"
    >
      {toast ? (
        <div
          role="status"
          aria-live="polite"
          className={`fixed right-3 top-[max(0.75rem,env(safe-area-inset-top))] z-[60] max-w-[min(calc(100vw-1.5rem),20rem)] rounded-xl px-3 py-2.5 text-xs font-semibold sm:right-4 sm:px-4 sm:py-3 sm:text-sm ${
            toast.type === 'success'
      ...
      <div className="relative flex h-[min(52rem,calc(100dvh-1rem))] w-full max-w-[min(calc(100vw-1rem),24rem)] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white sm:rounded-[1.75rem] md:max-w-[24rem] md:rounded-[1.875rem]">
        ...
        <div className="relative z-0 flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden overscroll-y-contain [-webkit-overflow-scrolling:touch]">
          ...
          >
              ...
              <div className="relative bg-[#1e40af] px-4 py-4 sm:px-6 sm:py-5">
                ...
                <div className="relative flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <h1 className="text-balance text-[clamp(1.25rem,3.5vw+0.5rem,1.85rem)] font-semibold leading-tight tracking-tight text-white sm:text-3xl">
                      My profile
                    </h1>
            ...
            <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 sm:rounded-3xl sm:p-5">
            ...
            <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 sm:rounded-3xl sm:p-5">
              ...
              <button
                ...
                className="touch-manipulation mb-4 flex min-h-[48px] w-full items-center justify-center gap-2 rounded-2xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground transition active:scale-[0.99] hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 sm:min-h-0 sm:w-auto sm:px-5"
              >
