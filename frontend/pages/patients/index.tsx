        ...
        <div className="relative z-0 flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden overscroll-y-contain [-webkit-overflow-scrolling:touch]">
          ...
          >
            ...
            <div className="mb-8 sm:mb-10">
              <ol className="grid list-none grid-cols-3 gap-2 p-0 sm:gap-4" aria-label="How it works">
            ...
            <fieldset className="m-0 mb-5 min-w-0 border-0 p-0" aria-describedby="pathway-hint">
                  <legend className="mb-1 block px-0 text-xs font-bold text-slate-900 sm:text-sm">What problem are you having?</legend>
                    ...
                    <button
                      ...
                      onClick={() =>
                        setSelectedPathways((current) =>
                          ...
                          className={`touch-manipulation flex aspect-square w-full min-h-0 flex-col items-center justify-center gap-1 rounded-xl border p-2 text-center transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 sm:p-2.5 ${
                        isSelected
